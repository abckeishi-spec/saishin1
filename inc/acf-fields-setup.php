...
function gi_register_acf_field_groups() {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                'key' => 'field_tool_price_monthly',
                'label' => '月額料金',
                'name' => 'price_monthly',
                'type' => 'number',
                'instructions' => '月額料金を円単位で入力してください',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '33',
            ...
            array(
                'key' => 'field_tool_price_free',
                'label' => '無料プラン',
                'name' => 'price_free',
                'type' => 'true_false',
                'instructions' => '無料プランがある場合はチェック',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '33',
            ...
            array(
                ...
                'name' => 'features',
                'type' => 'textarea',
                'instructions' => 'ツールの主要な機能を記載してください',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                'key' => 'field_tool_company',
                'label' => '提供会社',
                'name' => 'company',
                'type' => 'text',
                'instructions' => 'ツールを提供している会社名',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
        ...
        'hide_on_screen' => '',
        'active' => true,
        'description' => 'ビジネスツールの詳細情報を管理します',
        'show_in_rest' => 0,
    ));
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'name' => 'difficulty',
                'type' => 'select',
                'instructions' => 'コンテンツの難易度を選択してください',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
            ...
            array(
                'key' => 'field_tip_reading_time',
                'label' => '読了時間（分）',
                'name' => 'reading_time',
                'type' => 'number',
                'instructions' => '記事を読むのにかかる目安時間',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
            ...
            array(
                'key' => 'field_tip_usefulness_rating',
                'label' => '有用性評価',
                'name' => 'usefulness_rating',
                'type' => 'number',
                'instructions' => '読者からの評価（5段階）',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
