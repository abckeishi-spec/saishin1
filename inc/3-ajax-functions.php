...
function gi_ajax_load_grants() {
    ...
    $tags = json_decode(stripslashes($_POST['tags'] ?? '[]'), true); // 🆕 助成金タグ
    ...
    // 検索語句によるメタフィールド検索を追加
    if (!empty($search) && isset($search_meta_query)) {
